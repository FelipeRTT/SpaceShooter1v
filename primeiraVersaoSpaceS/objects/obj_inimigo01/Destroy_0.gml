...
if(tomei_tiro){
	scr_treme(20,noone,"inimigos"); // fazendo pelo script 
...
if(chanceSpawn <=2 && obj_player.lvltiro <=5 ){ //checando se o nvl do tiro ja nao é o maximo, se for, nao dropara novamente
